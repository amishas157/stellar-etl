...
- `data-integrity/027-offer-state-amount-float64-rounding.md` — Critical — `offers.amount` rounds distinct large offer sizes together and exports the wrong monetary value
